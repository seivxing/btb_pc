<div>
    ...
    <div class="py-3 py-md-4 checkout">
        <div class="container">
            ...
            <?php if($this->totalProductAmount != '0'): ?>
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <div class="shadow bg-white p-3">
                            <h4 class="text-primary">
                                Total Amount :
                                <span class="float-end">$ <?php echo e($this->totalProductAmount); ?></span>
                            </h4>
                            <hr>
...
<?php /**PATH C:\Users\Seiv Yi\Downloads\dd\E_commerce\resources\views\livewire\pages\user\checkoutproduct\check-out-component.blade.php ENDPATH**/ ?>