...
<div wire:ignore.self class="modal fade" id="addLaptopModal" data-bs-backdrop="static" data-bs-keyboard="false"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form wire:submit.prevent="storeStockProduct" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-3">
                        <select wire:model.defer="productcategory_id" id="" class="form-select mb-3">
                            ...
                            <?php $__currentLoopData = $productcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($productcategory->id); ?>"><?php echo e($productcategory->category_name); ?></option>
                    ...
                    <div class="mb-3">
                        <select wire:model.defer="brand_id" id="" class="form-select mb-3">
                            ...
                            <?php $__currentLoopData = $productbrands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productbrand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($productbrand->id); ?>"><?php echo e($productbrand->brand); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                        <?php if($image): ?>
                        <img class="rounded mt-3 d-block" src="<?php echo e($image->temporaryUrl()); ?>" alt="" style="width: 90px;height: 90px;">
                        <?php endif; ?>
                    </div>
                    <div class="mb-3">
...
<?php /**PATH C:\Users\Seiv Yi\Downloads\dd\E_commerce\resources\views\livewire\pages\admin\addstockproduct\modal-form.blade.php ENDPATH**/ ?>