...
$__html = app('livewire')->mount($__name, $__params, 'lw-4164340636-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-4164340636-1', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('pages.user.checkoutproduct.check-out-component', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-4164340636-2', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('layout.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Seiv Yi\Downloads\dd\E_commerce\resources\views\pages\user\checkoutproduct\index.blade.php ENDPATH**/ ?>