            ...
            <tbody>
                ...
                <?php $__currentLoopData = $order->orderItem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orderItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td width="10%"><img src="<?php echo e(asset('storage/' . $orderItem->laptop->image)); ?>"
                                class="mr-3" style="height: 100px !important" alt="">
                        </td>
                        <td><?php echo e($orderItem->laptop->model); ?></td>
...
<?php /**PATH C:\Users\Seiv Yi\Downloads\dd\E_commerce\resources\views\livewire\pages\user\tracking\tracking-detail.blade.php ENDPATH**/ ?>