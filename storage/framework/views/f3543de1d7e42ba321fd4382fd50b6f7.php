...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-floating mb-3">
                    ...
                    <input wire:model="email" type="text" name="email"
                        class="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300"
                        id="floatingInput" placeholder="YourEmail">
                        <?php if($recommendedEmail): ?>
                <span class="recommended-email">Recommended: <?php echo e($recommendedEmail); ?></span>
            <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-floating mb-4">
                    ...
                    <input wire:model="retype_password" type="password" name="retype_password"
                        class="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group mb-3">
                   ...
                   <div wire:ignore>
                    ...
                    <?php echo NoCaptcha::display(['data-callback'=>'onCallback']); ?>
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    <span class="text-blue-500">Please refresh the page for Captcha re-validation. Or u can just wait 30sec for submit the form again</span>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                ...
                <button type="submit"
                    class="w-full bg-black text-white p-2 rounded-md hover:bg-gray-800 focus:outline-none focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300">Register
                    Now</button>
            </form>
        </div>
    </div>
...
<script type="text/javascript">
    var onCallback =function(){
        ...
        set('g_recaptcha_response',grecaptcha.getResponse());
    };
</script>
<?php /**PATH C:\Users\Seiv Yi\Downloads\dd\E_commerce\resources\views\livewire\register-user.blade.php ENDPATH**/ ?>