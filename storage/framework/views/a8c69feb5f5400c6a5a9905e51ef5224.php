...
unset($__errorArgs, $__bag); ?>
                    ...
                    <button type="submit"
                        class="w-full bg-black text-white p-2 rounded-md hover:bg-gray-800 focus:outline-none focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300">Login
                        Now</button>
...
<?php /**PATH C:\Users\Seiv Yi\Downloads\dd\E_commerce\resources\views\auth\login.blade.php ENDPATH**/ ?>