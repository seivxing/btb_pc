    ...
    <div class="shadow bg-white p-3">
        <div class="row p-3">
            ...
            <div class="col-nd-6">
                <h5>User Detail</h5>
                <hr>
                <h6>User Name : <?php echo e($user->name); ?></h6> <!-- Accessing user's name -->
                <h6>Email : <?php echo e($user->email); ?></h6> <!-- Accessing user's email -->
...
<?php /**PATH C:\Users\Seiv Yi\Downloads\dd\E_commerce\resources\views\livewire\pages\admin\producttrackingadmin\product-tracking-detail-admin.blade.php ENDPATH**/ ?>