...
$__html = app('livewire')->mount($__name, $__params, 'lw-1312638049-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1312638049-1', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('pages.user.producttracking.product-tracking-detail', ['orderId' => $orderId]);

$__html = app('livewire')->mount($__name, $__params, 'lw-1312638049-2', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('layout.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Seiv Yi\Downloads\dd\E_commerce\resources\views\pages\user\trackingproduct\producttracking-detail.blade.php ENDPATH**/ ?>