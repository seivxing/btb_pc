<div>
    <?php echo $__env->make('livewire.pages.admin.directlybuy.modal-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="bg-light text-center rounded p-4">
        <div class="table-responsive">
            ...
            <table class="table  text-center text-start align-middle table-bordered table-hover mb-0">
                ...
                <tbody>
                    <?php $__currentLoopData = $buyproducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $buyproduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($buyproduct->id); ?></td>
                            <td><?php echo e($buyproduct->productcategory->category_name); ?></td>
                            <td><?php echo e($buyproduct->productbrand->brand); ?></td>
                            <td><?php echo e($buyproduct->model); ?></td>
                            <td><?php echo e($buyproduct->price); ?></td>
                            <td><?php echo e($buyproduct->gpu); ?></td>
                            <td><?php echo e($buyproduct->cpu); ?></td>
                            <td><?php echo e($buyproduct->ram); ?></td>
                            <td ><?php echo e($buyproduct->quantity); ?>

                            </td>
                            <td><?php echo e($buyproduct->color); ?></td>
                            <td><?php echo e($buyproduct->display); ?></td>
                            <td><?php echo e($buyproduct->weight); ?></td>
                            <td><?php echo e($buyproduct->battery); ?></td>
                            <td><?php echo e($buyproduct->official_warranty); ?></td>
                            <td><?php echo e($buyproduct->total_amount); ?></td>
                            <td>
                                <a href="<?php echo e(asset('storage/' . $buyproduct->image)); ?>" download>
                                    <img style="height: 120px !important;width:200px !important" src="<?php echo e(asset('storage/' . $buyproduct->image)); ?>" alt=""
                                    class="img-fluid" ></a></td>
                            <td><?php echo e($buyproduct->description); ?></td>
                            <td>
                                <div class="btn-group" role="group">
                                    <a type="" class="btn btn-success"
                                        wire:click="editBuyProduct(<?php echo e($buyproduct->id); ?>)" data-bs-toggle="modal"
                                        data-bs-target="#editLaptopModal">Edit</a>
                                    <a type="" class="btn btn-danger"
                                        wire:click="deleteBuyProduct(<?php echo e($buyproduct->id); ?>)" data-bs-toggle="modal"
...
<?php /**PATH C:\Users\Seiv Yi\Downloads\dd\E_commerce\resources\views\livewire\pages\admin\directlybuy\directly-buy.blade.php ENDPATH**/ ?>